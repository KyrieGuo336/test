...
//Teacher tea[100]={{20304050,"123456","李四","男",55,1963,20,-1,1}};
...
void tea_add_stu(void)
{
	...
	else
	{
		...
		/*
		FILE *fap=fopen("学生信息.txt","a");
		fprintf(fap,"%d %d %s %s %d\n",count_stu+1,stu[count_stu].id,stu[count_stu].name,stu[count_stu].sex,stu[count_stu].year);
		fclose(fap);
		*/
		count_stu += 1;
		printf("添加完成！\n");
